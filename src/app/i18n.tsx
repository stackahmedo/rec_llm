...
const en: Dict = {
  ...
  "dashboard.subtitle": "Overview of recordings, processing and AI learning",
  "dashboard.processingQueue": "Processing Queue",
  "dashboard.waiting": "Waiting",
  "dashboard.processing": "Processing",
  "dashboard.rendering": "Rendering",
  "dashboard.completed": "Completed",
  "dashboard.failed": "Failed",
  "dashboard.notifications": "Notifications",
  "dashboard.assemblyKeyNotConfigured": "AssemblyAI key not configured",
  "dashboard.summaryProviderNotConfigured": "No summary provider configured",
  "dashboard.apiStatus": "API Status",
  "dashboard.noKey": "No key",
  "dashboard.ready": "Ready",
  "dashboard.checked": "Checked",
  "dashboard.configureKeys": "Configure keys",
  ...
  "dashboard.noJobsYet": "No jobs yet. Upload audio to get started.",
  "dashboard.recommendations": "Recommendations",
  "dashboard.configureAssemblyKey": "Configure AssemblyAI key to start transcribing",
  "dashboard.generateSummariesRec": "Generate AI summaries for completed transcripts",
  "dashboard.retryFailedRec": "Retry failed jobs or check API connection",
  "dashboard.exportPendingRec": "Export pending transcripts to PDF",
  "dashboard.clearCacheRec": "Clear cache to free disk space",
  "dashboard.allReady": "All systems ready. Upload audio to begin.",
  "dashboard.quickActions": "Quick Actions",
  "dashboard.uploadAudio": "Upload Audio",
  "dashboard.exportPdf": "Export PDF",
  "dashboard.apiSettings": "API Settings",
  "dashboard.fileLibrary": "File Library",
  "dashboard.setupRequired": "Setup Required",
  "dashboard.configureApiKeysMessage": "Configure API keys in Settings to enable transcription and AI analysis.",
  "dashboard.openSettings": "Open Settings",
  "dashboard.ffmpegMissing": "FFmpeg not found — reinstall RecLLM",
  "dashboard.failedJobsAttention": "failed job(s) need attention",
  "dashboard.filesCompletedToday": "file(s) completed today",
...
const ja: Dict = {
  ...
  "dashboard.subtitle": "録音・処理・AI学習の概要",
  "dashboard.processingQueue": "処理キュー",
  "dashboard.waiting": "待機中",
  "dashboard.processing": "処理中",
  "dashboard.rendering": "生成中",
  "dashboard.completed": "完了",
  "dashboard.failed": "失敗",
  "dashboard.notifications": "通知",
  "dashboard.assemblyKeyNotConfigured": "AssemblyAIキーが未設定です",
  "dashboard.summaryProviderNotConfigured": "要約プロバイダーが未設定です",
  "dashboard.apiStatus": "APIステータス",
  "dashboard.noKey": "キーなし",
  "dashboard.ready": "準備完了",
  "dashboard.checked": "確認時刻",
  "dashboard.configureKeys": "キーを設定",
  "dashboard.today": "今日",
  "dashboard.files": "ファイル",
  "dashboard.size": "サイズ",
  "dashboard.output": "出力",
  "dashboard.pdfs": "PDF",
  "dashboard.summaries": "要約",
  "dashboard.pending": "保留中",
  "dashboard.storage": "ストレージ",
  "dashboard.total": "合計",
  "dashboard.transcripts": "文字起こし",
  "dashboard.recentJobs": "最近のジョブ",
  "dashboard.noJobsYet": "ジョブはまだありません。音声をアップロードしてください。",
  "dashboard.recommendations": "推奨事項",
  "dashboard.configureAssemblyKey": "文字起こしを開始するにはAssemblyAIキーを設定してください",
  "dashboard.generateSummariesRec": "完了した文字起こしのAI要約を生成してください",
  "dashboard.retryFailedRec": "失敗したジョブを再試行するか、API接続を確認してください",
  "dashboard.exportPendingRec": "保留中の文字起こしをPDFにエクスポートしてください",
  "dashboard.clearCacheRec": "キャッシュをクリアしてディスク容量を確保してください",
  "dashboard.allReady": "すべてのシステムが準備完了です。音声をアップロードして開始してください。",
  "dashboard.quickActions": "クイック操作",
  "dashboard.uploadAudio": "音声をアップロード",
  "dashboard.exportPdf": "PDF出力",
  "dashboard.apiSettings": "API設定",
  "dashboard.fileLibrary": "ファイルライブラリ",
  "dashboard.setupRequired": "設定が必要です",
  "dashboard.configureApiKeysMessage": "文字起こしとAI分析を有効にするには、設定でAPIキーを登録してください。",
  "dashboard.openSettings": "設定を開く",
  "dashboard.ffmpegMissing": "FFmpegが見つかりません — RecLLMを再インストールしてください",
  "dashboard.failedJobsAttention": "件の失敗したジョブに対応が必要です",
  "dashboard.filesCompletedToday": "件のファイルが今日完了しました",
